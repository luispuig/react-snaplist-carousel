...
export const List = () => {
  ...
  return (
    <div className={styles.wrapper}>
      <SnapList ref={snapList} direction="horizontal" height="auto" scrollPadding={{ left: '0' }}>
        <SnapItem padding={{ left: 'calc(50% - (100px - 50px)/2)', right: '10px' }} snapAlign="center">
        ...
        <SnapItem padding={{ left: '10px', right: 'calc(50% - (100px - 10px)/2)' }} snapAlign="center">
